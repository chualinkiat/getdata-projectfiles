...
1. Please ensure that the getdata-projectfiles-UCI HAR Dataset.zip has been unzip into the R working folder with the folder name beginning with "UCI HAR Dataset"

## How to run the script

1. Open your R Studio
2. execute "run_analysis.R" in your linux machine. It could not run in Windows because of the file path.
3. It will generate the tidyData.txt in your R working folder
